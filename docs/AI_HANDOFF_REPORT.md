...
- **Current `main` commit**: `b088185` post PR #316 (docs(handoff): mark PR #313 CLOSED + anti-duplicate guard MERGED, CI all GREEN). PR #246..#316 MERGED into main. **This session mở PR**: Phase 11.4.C UI Gem socket — combined backend+UI medium PR fix gem inventory visibility + wire socket/unsocket/combine UI.
