...
> **Snapshot**: `main` @ commit (post-PR #54 + #55 + #56 merged 28 Apr 2026, cập nhật SHA khi PR #57/G2 merge). Đang mở: **PR #57 G2 (L4 itemName helper, +11 test)** rebased after PR #56.
> **Người viết**: AI engineer session 28/4 sess.5 (PR #52 audit + PR #53 replay + PR #54 G4 + PR #55 G1 store + PR #56 G1 render + PR G2 L4 itemName).
...
### PR G2 — `feat(web): itemName(key, t?) helper + dedupe rendering across views` (G2/L4)
